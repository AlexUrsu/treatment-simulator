...
//    ? побочные эффекты ? как-то надо додумать
...
implementation
  ...
  begin
   ...
   sedativ, anxiolit: real;
    begin
    CreateDrug;
    group:='транквилизатор';

      if namedrug='Алпразолам' then begin
      anxiolit:=4;
      sedativ:=1;
      doza:=doza/2;
      end;

      if namedrug='Грандаксин' then begin
      anxiolit:=2;
      sedativ:=0.25;
      doza:=doza/5;
      end;

      if namedrug='Диазепам' then begin
      anxiolit:=3;
      sedativ:=2;
      doza:=doza/4;
      end;

      if namedrug='Клоназепам' then begin
      anxiolit:=4;
      sedativ:=2;
      doza:=doza/2;
      end;

      if namedrug='Нитразепам' then begin
      anxiolit:=2;
      sedativ:=3;
      doza:=doza/3;
      end;

      if namedrug='Феназепам' then begin
      anxiolit:=5;
      sedativ:=2;
      doza:=doza/1;
      end;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   begin
    ...
    group:='нейролептик';
      {
      В общем делаем поб эффеты пока рассписываем переменные
      в нач переменные, потом умножить на селф - или лучше сразу умножить на сэлф!!это же препарат а не общий эффект.
      переменная глобальная сразу в сэлф записывается
      }

      if namedrug='Циклодол' then begin
      antipsih:=0.1;
      antibred:=0.1;
      sedativ:=0.1;
      doza:=doza/2;
      ...
      if namedrug='Аминазин' then begin
      antipsih:=2;
      antibred:=2;
      sedativ:=5;
      doza:=doza/100;
      ...
      if namedrug='Хлорпротиксен' then begin
      antipsih:=2;
      antibred:=1;
      sedativ:=4;
      doza:=doza/50;
      ...
      self.holinolit:=5*doza;
      self.endo:=4*doza;
      /////////////////
      end;

      if namedrug='Тизерцин' then begin
      antipsih:=1;
      antibred:=1;
      sedativ:=6;
      doza:=doza/80;
      ...
      if namedrug='Галоперидол' then begin
      antipsih:=4;
      antibred:=3;
      sedativ:=2;
      doza:=doza/8;
      ...
      if namedrug='Трифтазин' then begin
      antipsih:=3;
      antibred:=4;
      sedativ:=1;
      doza:=doza/10;
      ...
      if namedrug='Мажептил' then begin
      antipsih:=5;
      antibred:=3;
      sedativ:=1;
      doza:=doza/7;
      ...
      if namedrug='Эглонил' then begin
      antipsih:=2;
      antibred:=1;
      sedativ:=1;
      doza:=doza/150;
      ...
      if namedrug='Рисперидон' then begin      ///!!!!!!!!!!!!!!!!!
      antipsih:=2;
      antibred:=3;
      sedativ:=1;
      doza:=doza/1;
      ...
      if namedrug='Азалептин' then begin
      antipsih:=6;
      antibred:=8;
      sedativ:=4;
      doza:=doza/70;
      ...
      if namedrug='Зипрекса' then begin
      antipsih:=3;
      antibred:=3;
      sedativ:=2;
      doza:=doza/2;
      ...
      if namedrug='Неулептил' then begin
      antipsih:=1;
      antibred:=1;
      sedativ:=3;
      doza:=doza/15;
      ...
      if namedrug='Сонапакс' then begin
      antipsih:=1;
      antibred:=1;
      sedativ:=3;
      doza:=doza/40;
    ...
    self.hyper_hypostesia_anestesia:=Round(-OS_EFFECT*doza);
...
//        self.shperrung:=EFFECT*doza;
   ...
   sedativ: real;
    ...
    group:='седатик';
      ...
      if namedrug='Экстракт валерьяны' then begin
      sedativ:=1;
      doza:=doza/2;
      end;

      if namedrug='Беллатаминал' then begin
      sedativ:=3;
      doza:=doza/2;
      end;

      if namedrug='Экстракт пустырника' then begin
      sedativ:=2;
      doza:=doza/2;
      end;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   begin
    ...
    group:='нормотимик';
      ...
      if namedrug='Финлепсин' then begin
      normotim:=2;
      doza:=doza/500;
      end;

      if namedrug='Лития карбонат' then begin
      normotim:=3;
      doza:=doza/600;
      end;

      if namedrug='Вальпроат натрия' then begin
      normotim:=1;
      doza:=doza/400;
      end;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   sedativ: real;
    ...
    CreateDrug;
    group:='адаптаген';
      if namedrug='Элеутерококк' then begin
      sedativ:=2;
      doza:=doza/20;
      end;

      if namedrug='Женьшень' then begin
      sedativ:=1;
      doza:=doza/20;
      end;

      if namedrug='Настойка аралии' then begin
      sedativ:=3;
      doza:=doza/20;
      end;
    ...
    self.hyper_hypotimia:=Round(DEISTVIE*doza);
    self.hyper_hypomnesia:=Round(DEISTVIE*doza);
    self.adrenolit:=Round(-DEISTVIE*doza);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    self.rigidnost:=Round(self.rigidnost*sedativ);
    self.hyper_hypotimia:=Round(self.hyper_hypotimia*sedativ);
    self.adrenolit:=Round(self.adrenolit*sedativ);
   end;
   ...
   begin
    ...
    // сексуальные расстрйства?? нада как-то вписать в ингибиторы захв серы
    // эндокринологию?


      if namedrug='Мелипрамин' then begin
      hipertim:=4;
      sedat:=-2;
      doza:=doza/100;
      ///////////////
      ...
      if namedrug='Флуоксетин' then begin
      hipertim:=3;
      sedat:=-1;
      doza:=doza/15;
      ///////////////
      ...
      if namedrug='Аурорикс' then begin
      hipertim:=3;
      sedat:=-3;
      doza:=doza/150;
      ///////////////
      ...
      if namedrug='Анафранил' then begin
      hipertim:=5;
      sedat:=0.1;
      doza:=doza/100;
      ///////////////
      ...
      if namedrug='Людиомил' then begin
      hipertim:=3;
      sedat:=1;
      doza:=doza/100;
      ///////////////
      ...
      if namedrug='Флувоксамин' then begin
      hipertim:=3;
      sedat:=1;
      doza:=doza/100;
      ///////////////
      ...
      if namedrug='Леривон' then begin
      hipertim:=3;
      sedat:=3;
      doza:=doza/35;
      ///////////////
      ...
      if namedrug='Амитриптилин' then begin
      hipertim:=4;
      sedat:=5;
      doza:=doza/100;
      ///////////////
...
////////////////////////////////////////////////////////////////////////////////
   ...
   begin
    ...
    group:='ноотроп';
      ...
      if namedrug='Пирацетам' then begin
      noot:=5;
      sedativ:=-2;
      doza:=doza/200;
      ///////////////
      ...
      if namedrug='Аминалон' then begin
      noot:=3;
      sedativ:=-1;
      doza:=doza/150;
      ///////////////
      ...
      if namedrug='Пантогам' then begin
      noot:=3;
      sedativ:=2;
      doza:=doza/200;
      ///////////////
      ...
      if namedrug='Фенибут' then begin
      noot:=3;
      sedativ:=3;
      doza:=doza/100;
      ///////////////
      ...
      if namedrug='Церебролизин' then begin
      noot:=4;
      sedativ:=-1;
      doza:=doza/20;
      ///////////////
